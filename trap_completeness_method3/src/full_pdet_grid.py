...
def run_stage(
        ...
        for tau_index, tau in enumerate(tau_grid):
            for amplitude_index, amplitude in enumerate(amplitude_grid):
                ...
                if progress_every and (
                    ...
                    fits_done = completed_grid_points * int(realizations)
                    ...
                    print(
                        ...
                        f"{fits_done}/{total_expected_fits} fits; "
    ...
    metadata = {
        ...
        "model_choice": {
            ...
            "local_noise": "Stage 03 exact (T, quadrant, dtph) trap-free samples; 200 K filtered to April-only source FITS.",
